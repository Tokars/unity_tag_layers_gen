namespace OT.Gen.Editor.Settings
{
    ...
    internal static class TlgSettingsDefaults
    {
        ...
        private const string DefaultClassPath = "/Scripts/Generated";
        ...
        {
            typeName = DefaultTagTypeName, filePath = DefaultClassPath, nameSpace = DefaultNamespace
        };
        ...
        {
            typeName = DefaultLayerTypeName, filePath = DefaultClassPath, nameSpace = DefaultNamespace
        };

        /// <summary>Default settings for <see cref="TlgSettings.layer" />.</summary>
        internal static readonly TlgSettings.Settings SortingLayer = new TlgSettings.Settings
        {
            typeName = DefaultSortingLayerTypeName, filePath = DefaultClassPath, nameSpace = DefaultNamespace
        };
    }
}
